...
img = pygame.image.load('Unknown.jpeg')
image = pygame.transform.scale(img, [200, 200])

start_img = pygame.image.load('th.jpeg').convert_alpha()
exit_img = pygame.image.load('th-1.jpeg').convert_alpha()
options_img1 = pygame.image.load('th-2.jpeg').convert_alpha()
options_img = pygame.transform.scale(options_img1, (50, 50))
return_img1 = pygame.image.load('th-3.jpeg').convert_alpha()
